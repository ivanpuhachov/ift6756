# Example from https://github.com/BachiLi/diffvg/blob/master/apps/single_circle.py
...
img = render(256, # width
             ...
             None,
             *scene_args)
pydiffvg.imwrite(img.cpu(), 'logs/single_circle/init.png', gamma=2.2)
...
for t in range(20):
    ...
    pydiffvg.imwrite(img.cpu(), 'logs/single_circle/iter_{}.png'.format(t), gamma=2.2)
...
pydiffvg.imwrite(img.cpu(), 'logs/single_circle/final.png')

# Convert the intermediate renderings to a video.
# from subprocess import call
# call(["ffmpeg", "-framerate", "24", "-i",
#     "logs/single_circle/iter_%d.png", "-vb", "20M",
#     "logs/single_circle/out.mp4"])
